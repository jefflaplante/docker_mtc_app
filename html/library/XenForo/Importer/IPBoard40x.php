...
class XenForo_Importer_IPBoard40x extends XenForo_Importer_IPBoard34x
{
	...
	public function getSteps()
	{
		...
		$steps = array_slice($originalSteps, 0, 3, true); // up to and including users

		$steps['ignoredUsers'] = array(
			'title' => new XenForo_Phrase('import_ignored_users'),
			'depends' => array('users')
		); // add new step

		$steps += array_slice($originalSteps, 3, count($originalSteps), true); // append everything after users
