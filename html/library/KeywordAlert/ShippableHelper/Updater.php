...
// updated by DevHelper_Helper_ShippableHelper at 2015-10-16T07:24:27+00:00

/**
 * Class KeywordAlert_ShippableHelper_Updater
 * @version 1
...
EOF;
        ...
        if (!empty($_GET[self::PARAM_DOWNLOAD])
            ...
            if (!empty($data[$addOnId]['links']['content'])) {
                $tempFile = KeywordAlert_ShippableHelper_TempFile::download($data[$addOnId]['links']['content']);
