...
class SSD_CustomMarkupForUser_Constants {
    public static $availableMarkups = array(
        // Text Effects
        "bold" => array(
            "category" => "textEffects",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyBool", "error" => "SSD_cmfu_bold_option_selection_invalid"),
        ...
        "italic" => array(
            "category" => "textEffects",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyBool", "error" => "SSD_cmfu_italic_option_selection_invalid"),
            "type" => XenForo_Input::UINT,
        ...
        "underline" => array(
            "category" => "textEffects",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyBool", "error" => "SSD_cmfu_underline_option_selection_invalid"),
            "type" => XenForo_Input::UINT,
        ...
        "overline" => array(
            "category" => "textEffects",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyBool", "error" => "SSD_cmfu_overline_option_selection_invalid"),
            "type" => XenForo_Input::UINT,
        ...
        "strike" => array(
            "category" => "textEffects",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyBool", "error" => "SSD_cmfu_strike_option_selection_invalid"),
            "type" => XenForo_Input::UINT,
        ...
        "text_colour" => array(
            "category" => "textEffects",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyColour", "error" => "SSD_cmfu_colour_code_invalid"),
        ...
        "font_face" => array(
            "category" => "textEffects",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyFontList", "error" => "SSD_cmfu_font_code_invalid"),
            "type" => XenForo_Input::UINT,
            "enable_prefix" => true,
        ...
        "border" => array(
            "category" => "bgBorders",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyBool", "error" => "SSD_cmfu_border_option_selection_invalid"),
            "type" => XenForo_Input::UINT,
        ...
        "border_style" => array(
            "category" => "bgBorders",
            "verify" => array("func" => "SSD_CustomMarkupForUser_Helpers::verifyBorderList", "error" => "SSD_cmfu_border_style_option_invalid"),
            "type" => XenForo_Input::UINT,
            "enable_prefix" => true,
