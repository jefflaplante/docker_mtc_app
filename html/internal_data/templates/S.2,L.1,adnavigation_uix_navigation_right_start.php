...
$__output .= '		<!-- extra tabs: uix_navigation_right_start -->
		';
if ($extraTabs['uix_navigation_right_start'])
{
$__output .= '
		';
foreach ($extraTabs['uix_navigation_right_start'] AS $extraTabId => $extraTab)
{
$__output .= '
			';
