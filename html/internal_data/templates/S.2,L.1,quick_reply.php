...
if ($visitor['isOnline'])
{
$__compilerVar3 .= '<span class="Tooltip onlineMarker" title="' . 'Online Now' . '" data-offsetX="-22" data-offsetY="-8">';
if (XenForo_Template_Helper_Core::styleProperty('uix_messageOnlineMarker_circlePulse'))
{
$__compilerVar3 .= '<span class="onlineMarker_pulse"></span>';
}
$__compilerVar3 .= '</span>';
}
$__compilerVar3 .= '
...
$__compilerVar10 .= '
			...
			';
$__compilerVar8 .= $this->callTemplateHook('message_user_info_custom_fields', $__compilerVar10, array(
'user' => $visitor,
'isQuickReply' => $__compilerVar1
));
