...
{
$__output .= 'Discussions' . ':';
}
$__output .= '</dt> <dd>' . (($category['privateInfo']) ? ('&ndash;') : (XenForo_Template_Helper_Core::numberFormat($category['discussion_count'], '0'))) . '</dd></dl>
				<dl><dt>';
if (XenForo_Template_Helper_Core::styleProperty('uix_nodeStatsIcons'))
{
...
$__output .= '</dt> <dd>' . (($category['privateInfo']) ? ('&ndash;') : (XenForo_Template_Helper_Core::numberFormat($category['message_count'], '0'))) . '</dd></dl>
				';
