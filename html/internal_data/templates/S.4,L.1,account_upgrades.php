...
$__output .= '
						...
						<input type="hidden" name="return" value="' . XenForo_Template_Helper_Core::link('full:account/upgrade-purchase', false, array()) . '" />
						<input type="hidden" name="cancel_return" value="' . XenForo_Template_Helper_Core::link('full:index', false, array()) . '" />
...
{
$__output .= '
							<a href="' . htmlspecialchars($payPalUrl, ENT_QUOTES, 'UTF-8') . '?cmd=_manage-paylist" class="button">' . 'Cancel Subscription' . '</a>
						';
}
$__output .= '
					</div>
