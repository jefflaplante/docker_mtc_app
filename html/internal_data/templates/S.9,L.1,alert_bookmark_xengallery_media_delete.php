...
$__output .= 'A media item you had bookmarked has been deleted.' . '<br />
...
{
$__output .= '
	<a href="' . XenForo_Template_Helper_Core::link('xengallery', $content, array()) . '">' . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . '</a>
';
}
else
{
