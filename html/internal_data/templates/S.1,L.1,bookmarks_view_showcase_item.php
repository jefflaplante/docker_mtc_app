...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'nflj_showcase_showcase_item' . ':</dt> <dd><span class="ugc"><a href="' . XenForo_Template_Helper_Core::link('showcase', $item['content'], array()) . '">
