...
$__compilerVar2 .= '
					<div class="fb-like" data-href="' . htmlspecialchars($url, ENT_QUOTES, 'UTF-8') . '" data-width="400" data-layout="standard" data-action="' . htmlspecialchars($xenOptions['facebookLikeAction'], ENT_QUOTES, 'UTF-8') . '" data-show-faces="true" data-colorscheme="' . XenForo_Template_Helper_Core::styleProperty('fbColorScheme') . '"></div>
				</div>
			';
}
$__compilerVar2 .= '
