...
$__compilerVar61 .= '
						';
$__compilerVar62 = '';
$__compilerVar62 .= XenForo_Template_Helper_Core::callHelper('userFieldValue', array(
'0' => $fieldInfo,
'1' => $post,
...
$__compilerVar61 .= '
			...
			';
$__compilerVar59 .= $this->callTemplateHook('message_user_info_custom_fields', $__compilerVar61, array(
'user' => $post,
'isQuickReply' => $isQuickReply
));
...
$__compilerVar64 .= '
					';
$__compilerVar63 .= $this->callTemplateHook('message_notices', $__compilerVar64, array(
'message' => $post
));
...
$__compilerVar66 = '';
$__compilerVar67 = '';
$__compilerVar66 .= $this->callTemplateHook('ad_message_body', $__compilerVar67, array());
...
$__compilerVar65 .= '
		...
		';
$__compilerVar52 .= $this->callTemplateHook('message_content', $__compilerVar65, array(
'message' => $post
));
...
$__compilerVar52 .= $__compilerVar68;
...
$__compilerVar52 .= '</div>
	...
	';
$__compilerVar69 = '';
$__compilerVar52 .= $this->callTemplateHook('message_below', $__compilerVar69, array(
'post' => $post,
...
$__compilerVar70 = '';
$__compilerVar71 = '';
$__compilerVar70 .= $this->callTemplateHook('ad_message_below', $__compilerVar71, array());
unset($__compilerVar71);
$__compilerVar52 .= $__compilerVar70;
...
$__compilerVar72 = '';
$__compilerVar73 = '';
$__compilerVar73 .= 'Post Moderation';
$__compilerVar74 = '';
$__compilerVar74 .= '
		';
if ($inlineModOptions['delete'])
{
$__compilerVar74 .= '<option value="delete">' . 'Delete Posts' . '...</option>';
}
$__compilerVar74 .= '
		';
if ($inlineModOptions['undelete'])
{
$__compilerVar74 .= '<option value="undelete">' . 'Undelete Posts' . '</option>';
}
$__compilerVar74 .= '
		';
if ($inlineModOptions['approve'])
{
$__compilerVar74 .= '<option value="approve">' . 'Approve Posts' . '</option>';
}
$__compilerVar74 .= '
		';
if ($inlineModOptions['unapprove'])
{
$__compilerVar74 .= '<option value="unapprove">' . 'Unapprove Posts' . '</option>';
}
$__compilerVar74 .= '
		';
if ($inlineModOptions['move'])
{
$__compilerVar74 .= '<option value="move">' . 'Move Posts' . '...</option>';
}
$__compilerVar74 .= '
		';
if ($inlineModOptions['copy'])
{
$__compilerVar74 .= '<option value="copy">' . 'Copy Posts' . '...</option>';
}
$__compilerVar74 .= '
		';
if ($inlineModOptions['merge'])
{
$__compilerVar74 .= '<option value="merge">' . 'Merge Posts' . '...</option>';
}
$__compilerVar74 .= '
		';
$__compilerVar75 = '';
...
{
$__compilerVar75 .= '<option value="editDate">' . 'Edit Posts Date' . '...</option>';
}
...
<option value="deselect">' . 'Deselect Posts' . '</option>
	';
$__compilerVar76 = '';
$__compilerVar76 .= 'Select / deselect all posts on this page';
$__compilerVar77 = '';
$__compilerVar77 .= 'Selected Posts';
$__compilerVar78 = '';
...
<span id="InlineModControls">
	<span class="selectionControl secondaryContent">
		<label for="ModerationCheck">
			' . 'Select All' . ' <input type="checkbox" id="ModerationCheck" title="' . htmlspecialchars($__compilerVar76, ENT_QUOTES, 'UTF-8') . '" />
		</label>
		...
		<a class="SelectionCount">' . htmlspecialchars($__compilerVar77, ENT_QUOTES, 'UTF-8') . ': <em class="InlineModCheckedTotal">0</em></a>
	</span>
...
if ($inlineModOptions['delete'])
{
$__compilerVar78 .= '<input type="submit" class="button" value="' . 'Delete' . '..." name="delete" />';
}
$__compilerVar78 .= '
			';
if ($inlineModOptions['approve'])
{
$__compilerVar78 .= '<input type="submit" class="button" value="' . 'Approve' . '" name="approve" />';
}
$__compilerVar78 .= '
		</span>
...
$__compilerVar72 .= $__compilerVar78;
unset($__compilerVar73, $__compilerVar74, $__compilerVar76, $__compilerVar77, $__compilerVar78);
...
$__compilerVar79 = '';
$__compilerVar80 = '';
$__compilerVar79 .= $this->callTemplateHook('ad_thread_view_below_messages', $__compilerVar80, array());
...
';
$__compilerVar81 = '';
$__output .= $this->callTemplateHook('thread_view_qr_before', $__compilerVar81, array(
'thread' => $thread
));
...
$__output .= '
	';
$__compilerVar86 = '';
$__compilerVar86 .= XenForo_Template_Helper_Core::link('threads/add-reply', $thread, array());
$__compilerVar87 = '';
$__compilerVar87 .= htmlspecialchars($lastPost['post_date'], ENT_QUOTES, 'UTF-8');
$__compilerVar88 = '';
$__compilerVar88 .= htmlspecialchars($thread['last_post_date'], ENT_QUOTES, 'UTF-8');
$__compilerVar89 = '';
$__compilerVar89 .= '1';
$__compilerVar90 = '';
$__compilerVar90 .= XenForo_Template_Helper_Core::link('threads/multi-quote', $thread, array(
'formId' => '#QuickReply'
));
$__compilerVar91 = '';
...
{
$__compilerVar91 .= '<h2 style="color:white;background:#f72600;border-radius:2px;padding:2px;text-align:center;">You need 3 posts to add links to your posts! This is used to prevent spam.</h2>';
}
$__compilerVar91 .= '
...
$__compilerVar95 .= ' title="' . 'Start a Conversation' . '" ><i class="fa fa-envelope Tooltip"></i></a></span></dl>
';
}
$__compilerVar95 .= '
';
...
{
$__compilerVar100 .= 'Male';
}
else
{
$__compilerVar100 .= 'Female';
}
$__compilerVar100 .= '</dd>
					</dl>
				';
...
$__compilerVar100 .= '
			...
			';
$__compilerVar99 .= $this->callTemplateHook('message_user_info_extra', $__compilerVar100, array(
'user' => $visitor,
'isQuickReply' => $__compilerVar92
));
...
$__compilerVar101 .= '
						';
$__compilerVar102 = '';
$__compilerVar102 .= XenForo_Template_Helper_Core::callHelper('userFieldValue', array(
'0' => $fieldInfo,
'1' => $visitor,
...
$__compilerVar101 .= '
			...
			';
$__compilerVar99 .= $this->callTemplateHook('message_user_info_custom_fields', $__compilerVar101, array(
'user' => $visitor,
'isQuickReply' => $__compilerVar92
));
...
if (XenForo_Template_Helper_Core::styleProperty('cbuaShowOverlay'))
{
$__compilerVar93 .= 'class="OverlayTrigger" data-cacheOverlay="false"';
}
if (XenForo_Template_Helper_Core::styleProperty('cbua_newwindow'))
{
$__compilerVar93 .= 'onclick="centeredPopup(this.href,\'myWindow\',\'800\',\'900\',\'yes\');return false"';
}
$__compilerVar93 .= ' >' . 'Start a Conversation' . '</a></dl>
';
}
$__compilerVar93 .= '
';
...
$__compilerVar91 .= '
	...
	<form action="' . htmlspecialchars($__compilerVar86, ENT_QUOTES, 'UTF-8', (false)) . '" method="post" class="AutoValidator blendedEditor" data-optInOut="OptIn" id="QuickReply">
...
$__compilerVar91 .= '
';
if ($xenOptions['multiQuote'] AND $__compilerVar90)
{
$__compilerVar91 .= '<input type="button" class="button JsOnly MultiQuoteWatcher insertQuotes" id="MultiQuote"
				value="' . 'Insert Quotes' . '..."
				tabindex="1"
				data-href="' . htmlspecialchars($__compilerVar90, ENT_QUOTES, 'UTF-8', (false)) . '"
...
if ($__compilerVar89)
{
$__compilerVar91 .= '<input type="submit" class="button DisableOnSubmit" value="' . 'More Options' . '..." name="more_options" />';
}
$__compilerVar91 .= '
		</div>
...
$__compilerVar109 .= '
			...
			<div class="controls JsOnly">				
				<input type="button" value="' . 'Delete' . '" class="button smallButton AttachmentDeleter" data-href="' . XenForo_Template_Helper_Core::link('attachments/delete', $__compilerVar108, array()) . '" />
...
$__compilerVar91 .= '
		...
		<input type="hidden" name="last_date" value="' . htmlspecialchars($__compilerVar87, ENT_QUOTES, 'UTF-8') . '" data-load-value="' . htmlspecialchars($__compilerVar87, ENT_QUOTES, 'UTF-8') . '" />
		<input type="hidden" name="last_known_date" value="' . htmlspecialchars($__compilerVar88, ENT_QUOTES, 'UTF-8') . '" />
		<input type="hidden" name="_xfToken" value="' . htmlspecialchars($visitor['csrf_token_page'], ENT_QUOTES, 'UTF-8') . '" />
...
unset($__compilerVar86, $__compilerVar87, $__compilerVar88, $__compilerVar89, $__compilerVar90, $__compilerVar91);
$__output .= '
';
}
$__output .= '
...
';
$__compilerVar113 = '';
$__output .= $this->callTemplateHook('thread_view_qr_after', $__compilerVar113, array(
'thread' => $thread
));
...
';
$__compilerVar118 = '';
$__compilerVar118 .= XenForo_Template_Helper_Core::link('canonical:threads', $thread, array());
$__compilerVar119 = '';
$__compilerVar120 = '';
$__compilerVar120 .= '
			';
...
'0' => $visitorLanguage['language_code']
						...
						data-url="' . htmlspecialchars($__compilerVar118, ENT_QUOTES, 'UTF-8') . '"
...
$__compilerVar121 .= '
				<div class="plusone shareControl">
					<div class="g-plusone" data-size="medium" data-count="true" data-href="' . htmlspecialchars($__compilerVar118, ENT_QUOTES, 'UTF-8') . '"></div>
				</div>
			';
}
$__compilerVar121 .= '
...
$__compilerVar121 .= '
					<div class="fb-like" data-href="' . htmlspecialchars($__compilerVar118, ENT_QUOTES, 'UTF-8') . '" data-width="400" data-layout="standard" data-action="' . htmlspecialchars($xenOptions['facebookLikeAction'], ENT_QUOTES, 'UTF-8') . '" data-show-faces="true" data-colorscheme="' . XenForo_Template_Helper_Core::styleProperty('fbColorScheme') . '"></div>
				</div>
			';
}
$__compilerVar121 .= '
			';
$__compilerVar120 .= $this->callTemplateHook('share_page_options', $__compilerVar121, array());
