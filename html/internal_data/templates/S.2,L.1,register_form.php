...
{
$__compilerVar6 .= '
				<li><label><input type="radio" name="' . htmlspecialchars($__compilerVar3, ENT_QUOTES, 'UTF-8') . '[' . htmlspecialchars($__compilerVar4['field_id'], ENT_QUOTES, 'UTF-8') . ']" value="" ' . (($__compilerVar4['field_value'] === ('') OR !$__compilerVar4['hasValue']) ? ' checked="checked"' : '') . ' /> <span class="muted">' . 'No selection' . '</span></label></li>
			';
}
$__compilerVar6 .= '
			';
...
{
$__compilerVar6 .= '
				<li><label><input type="radio" name="' . htmlspecialchars($__compilerVar3, ENT_QUOTES, 'UTF-8') . '[' . htmlspecialchars($__compilerVar4['field_id'], ENT_QUOTES, 'UTF-8') . ']" value="' . htmlspecialchars($choice, ENT_QUOTES, 'UTF-8') . '" ' . (($__compilerVar4['hasValue'] && strval($__compilerVar4['field_value']) == strval($choice)) ? ' checked="checked"' : '') . ' /> ' . $text . '</label></li>
			';
}
$__compilerVar6 .= '
			</ul>
...
{
$__compilerVar6 .= '
				<option value="' . htmlspecialchars($choice, ENT_QUOTES, 'UTF-8') . '" ' . (($__compilerVar4['hasValue'] && strval($__compilerVar4['field_value']) == strval($choice)) ? ' selected="selected"' : '') . '>' . $text . '</option>
			';
}
$__compilerVar6 .= '
			</select>
...
{
$__compilerVar10 .= '
				<li><label><input type="radio" name="' . htmlspecialchars($__compilerVar8, ENT_QUOTES, 'UTF-8') . '[' . htmlspecialchars($field['field_id'], ENT_QUOTES, 'UTF-8') . ']" value="" ' . (($field['field_value'] === ('') OR !$field['hasValue']) ? ' checked="checked"' : '') . ' /> <span class="muted">' . 'No selection' . '</span></label></li>
			';
}
$__compilerVar10 .= '
			';
...
{
$__compilerVar10 .= '
				<li><label><input type="radio" name="' . htmlspecialchars($__compilerVar8, ENT_QUOTES, 'UTF-8') . '[' . htmlspecialchars($field['field_id'], ENT_QUOTES, 'UTF-8') . ']" value="' . htmlspecialchars($choice, ENT_QUOTES, 'UTF-8') . '" ' . (($field['hasValue'] && strval($field['field_value']) == strval($choice)) ? ' checked="checked"' : '') . ' /> ' . $text . '</label></li>
			';
}
$__compilerVar10 .= '
			</ul>
...
{
$__compilerVar15 .= '
				<li><label><input type="radio" name="' . htmlspecialchars($__compilerVar12, ENT_QUOTES, 'UTF-8') . '[' . htmlspecialchars($__compilerVar13['field_id'], ENT_QUOTES, 'UTF-8') . ']" value="" ' . (($__compilerVar13['field_value'] === ('') OR !$__compilerVar13['hasValue']) ? ' checked="checked"' : '') . ' /> <span class="muted">' . 'No selection' . '</span></label></li>
			';
}
$__compilerVar15 .= '
			';
...
{
$__compilerVar15 .= '
				<li><label><input type="radio" name="' . htmlspecialchars($__compilerVar12, ENT_QUOTES, 'UTF-8') . '[' . htmlspecialchars($__compilerVar13['field_id'], ENT_QUOTES, 'UTF-8') . ']" value="' . htmlspecialchars($choice, ENT_QUOTES, 'UTF-8') . '" ' . (($__compilerVar13['hasValue'] && strval($__compilerVar13['field_value']) == strval($choice)) ? ' checked="checked"' : '') . ' /> ' . $text . '</label></li>
			';
}
$__compilerVar15 .= '
			</ul>
...
{
$__compilerVar15 .= '
				<option value="' . htmlspecialchars($choice, ENT_QUOTES, 'UTF-8') . '" ' . (($__compilerVar13['hasValue'] && strval($__compilerVar13['field_value']) == strval($choice)) ? ' selected="selected"' : '') . '>' . $text . '</option>
			';
}
$__compilerVar15 .= '
			</select>
