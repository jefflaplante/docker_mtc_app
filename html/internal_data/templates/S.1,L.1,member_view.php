...
$__output .= '
		...
		';
$__compilerVar12 = '';
$__output .= $this->callTemplateHook('member_view_sidebar_middle1', $__compilerVar12, array(
'user' => $user
));
...
';
$__compilerVar15 = '';
$__output .= $this->callTemplateHook('member_view_sidebar_middle2', $__compilerVar15, array(
'user' => $user
));
...
if ($birthday['age'])
{
$__compilerVar16 .= '<span class="age">(' . 'Age' . ': ' . XenForo_Template_Helper_Core::numberFormat($birthday['age'], '0') . ')</span>';
}
$__compilerVar16 .= '</dd></dl>
				';
}
...
$__output .= '
		...
		';
$__compilerVar18 = '';
$__output .= $this->callTemplateHook('member_view_sidebar_end', $__compilerVar18, array(
'user' => $user
));
...
$__compilerVar19 = '';
$__compilerVar20 = '';
$__compilerVar19 .= $this->callTemplateHook('ad_member_view_sidebar_bottom', $__compilerVar20, array());
...
'0' => $user
				...
				';
$__compilerVar23 = '';
$__compilerVar23 .= XenForo_Template_Helper_Core::callHelper('userBanner', array(
'0' => $user
));
...
{
$__compilerVar41 .= ', ' . 'Reason' . ': ' . htmlspecialchars($comment['delete_reason'], ENT_QUOTES, 'UTF-8');
}
$__compilerVar41 .= '.
			';
}
...
if ($comment['canEdit'])
{
$__compilerVar42 .= '<a href="' . XenForo_Template_Helper_Core::link('profile-posts/comments/edit', $comment, array()) . '" class="OverlayTrigger item control edit"><span></span>' . 'Edit' . '</a>';
}
$__compilerVar42 .= '
			';
if ($comment['canDelete'])
{
$__compilerVar42 .= '<a href="' . XenForo_Template_Helper_Core::link('profile-posts/comments/delete', $comment, array()) . '" class="OverlayTrigger item control delete"><span></span>' . 'Delete' . '</a>';
}
$__compilerVar42 .= '
			';
if ($comment['canReport'])
{
$__compilerVar42 .= '<a href="' . XenForo_Template_Helper_Core::link('profile-posts/comments/report', $comment, array()) . '" class="OverlayTrigger item control report"><span></span>' . 'Report' . '</a>';
}
$__compilerVar42 .= '
			';
$__compilerVar44 = '';
...
{
$__compilerVar45 .= '<li><a href="' . XenForo_Template_Helper_Core::link('profile-posts/comments/undelete', $comment, array(
...
{
$__compilerVar45 .= '<li><a href="' . XenForo_Template_Helper_Core::link('spam-cleaner', $comment, array()) . '" class="item control deleteSpam OverlayTrigger"><span></span>' . 'Spam' . '</a></li>';
}
$__compilerVar45 .= '
								';
if ($comment['canViewIps'])
{
$__compilerVar45 .= '<li><a href="' . XenForo_Template_Helper_Core::link('profile-posts/comments/ip', $comment, array()) . '" class="OverlayTrigger item control ip"><span></span>' . 'IP' . '</a></li>';
}
$__compilerVar45 .= '
								';
if ($comment['canWarn'])
...
$__compilerVar42 .= '
				';
$__compilerVar47 = '';
$__compilerVar47 .= XenForo_Template_Helper_Core::link('profile-posts/comments/likes', $comment, array());
$__compilerVar48 = '';
if ($comment['likes'])
{
$__compilerVar48 .= '
...
$__compilerVar48 .= '
	<div class="likesSummary secondaryContent">
		<span class="LikeText">
			' . XenForo_Template_Helper_Core::callHelper('likeshtml', array($comment['likes'],$__compilerVar47,$comment['like_date'],$comment['likeUsers'])) . '
		</span>
	</div>
';
}
...
$__compilerVar51 .= '
					';
$__compilerVar50 .= $this->callTemplateHook('message_simple_notices', $__compilerVar51, array(
'message' => $profilePost
));
...
$__compilerVar33 .= $__compilerVar49;
unset($__compilerVar34, $__compilerVar35, $__compilerVar49);
$__compilerVar33 .= '
' . '
';
...
$__compilerVar52 = '';
$__compilerVar53 = '';
$__compilerVar53 .= 'Post Moderation';
$__compilerVar54 = '';
$__compilerVar54 .= '
		';
if ($inlineModOptions['delete'])
{
$__compilerVar54 .= '<option value="delete">' . 'Delete Posts' . '</option>';
}
$__compilerVar54 .= '
		';
if ($inlineModOptions['undelete'])
{
$__compilerVar54 .= '<option value="undelete">' . 'Undelete Posts' . '</option>';
}
$__compilerVar54 .= '
		';
if ($inlineModOptions['approve'])
{
$__compilerVar54 .= '<option value="approve">' . 'Approve Posts' . '</option>';
}
$__compilerVar54 .= '
		';
if ($inlineModOptions['unapprove'])
{
$__compilerVar54 .= '<option value="unapprove">' . 'Unapprove Posts' . '</option>';
}
$__compilerVar54 .= '
		<option value="deselect">' . 'Deselect Posts' . '</option>
	';
$__compilerVar55 = '';
$__compilerVar55 .= 'Select / deselect all posts on this page';
$__compilerVar56 = '';
$__compilerVar56 .= 'Selected Posts';
$__compilerVar57 = '';
...
<span id="InlineModControls">
	<span class="selectionControl secondaryContent">
		<label for="ModerationCheck">
			' . 'Select All' . ' <input type="checkbox" id="ModerationCheck" title="' . htmlspecialchars($__compilerVar55, ENT_QUOTES, 'UTF-8') . '" />
		</label>
		...
		<a class="SelectionCount">' . htmlspecialchars($__compilerVar56, ENT_QUOTES, 'UTF-8') . ': <em class="InlineModCheckedTotal">0</em></a>
	</span>
...
if ($inlineModOptions['delete'])
{
$__compilerVar57 .= '<input type="submit" class="button" value="' . 'Delete' . '..." name="delete" />';
}
$__compilerVar57 .= '
			';
if ($inlineModOptions['approve'])
{
$__compilerVar57 .= '<input type="submit" class="button" value="' . 'Approve' . '" name="approve" />';
}
$__compilerVar57 .= '
		</span>
...
if ($user['gender'] == ('male'))
{
$__compilerVar59 .= 'Male';
}
else
{
$__compilerVar59 .= 'Female';
}
$__compilerVar59 .= '</dd></dl>
										';
}
$__compilerVar59 .= '
...
if ($birthday['age'])
{
$__compilerVar59 .= '(' . 'Age' . ': ' . XenForo_Template_Helper_Core::numberFormat($birthday['age'], '0') . ')';
}
$__compilerVar59 .= '</dd></dl>
										';
}
...
if ($user['about'])
{
$__compilerVar58 .= '<div class="baseHtml ugc">' . $user['aboutHtml'] . '</div>';
}
$__compilerVar58 .= '
							';
...
'content' => 'thread'
									...
									';
$__output .= $this->callTemplateHook('member_view_search_content_types', $__compilerVar62, array());
...
$__output .= '
			...
			';
$__compilerVar65 = '';
$__output .= $this->callTemplateHook('member_view_tabs_content', $__compilerVar65, array(
'user' => $user
));
