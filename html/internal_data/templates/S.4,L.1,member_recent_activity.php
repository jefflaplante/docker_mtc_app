...
$__compilerVar5 = '';
$__compilerVar5 .= '<li id="' . (($itemId) ? (htmlspecialchars($itemId, ENT_QUOTES, 'UTF-8')) : ('item_' . htmlspecialchars($item['news_feed_id'], ENT_QUOTES, 'UTF-8'))) . '" class="event primaryContent NewsFeedItem" data-author="' . htmlspecialchars($item['username'], ENT_QUOTES, 'UTF-8') . '">
