...
$__extraData['title'] = '';
$__extraData['title'] .= 'Deleted Post';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Deleted Post';
$__output .= '
...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'Thread' . ':</dt> <dd><span class="ugc">
	';
...
{
$__output .= '
		<a href="' . XenForo_Template_Helper_Core::link('threads', $item['content'], array()) . '">' . htmlspecialchars($item['content']['title'], ENT_QUOTES, 'UTF-8') . '</a>
	';
}
$__output .= '
	<span></dd></dl>
