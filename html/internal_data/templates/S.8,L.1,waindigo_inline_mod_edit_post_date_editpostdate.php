...
';
$__extraData['title'] = '';
$__extraData['title'] .= 'Inline Moderation - Edit Post Date';
$__output .= '

<form action="' . XenForo_Template_Helper_Core::link('inline-mod/post/editdate', false, array()) . '" method="post" class="xenForm formOverlay">
	<p>' . 'Are you sure you want to change the post date of ' . htmlspecialchars($postCount, ENT_QUOTES, 'UTF-8') . ' post(s)?' . '</p>
...
$__output .= '
	<dl class="ctrlUnit">
		<dt><label for="ctrl_post_date">' . 'Post Date (unix timestamp)' . ':</label></dt>
		<dd><input type="text" name="post_date" value="' . htmlspecialchars($post['date'], ENT_QUOTES, 'UTF-8') . '" id="ctrl_post_date" class="textCtrl" maxlength="15" size="30" /></dd>
	</dl>
';
}
else
...
$__output .= '
	<dl class="ctrlUnit">
		...
		<dd>';
$__compilerVar1 = '';
$__compilerVar1 .= '<select name="month" class="textCtrl autoSize">
...
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" name="save" value="' . 'Edit Posts' . '" accesskey="s" class="button primary" /></dd>
	</dl>
