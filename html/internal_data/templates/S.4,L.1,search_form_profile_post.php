...
$__output .= '
	...
	<dl class="ctrlUnit">
		...
		<dd><input type="search" name="keywords" value="' . htmlspecialchars($search['keywords'], ENT_QUOTES, 'UTF-8') . '" class="textCtrl" id="ctrl_keywords" autofocus="true" /></dd>
	</dl>
	...
	<fieldset>
		...
		<dl class="ctrlUnit">
			<dt></dt>
			<dd>
				<label for="ctrl_search_comments"><input type="checkbox" name="search_comments" value="1"' . (($search['search_comments']) ? (' checked="checked"') : ('')) . ' id="ctrl_search_comments" /> ' . 'Search profile post comments' . '</label>
			</dd>
		</dl>
	</fieldset>
