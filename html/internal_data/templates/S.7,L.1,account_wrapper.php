...
$__compilerVar4 .= '
					...
					';
if ($xenOptions['waindigo_trophies_userCanEditTrophyDisplayOptions'])
{
$__compilerVar4 .= '
';
$__compilerVar5 = '';
$__compilerVar5 .= '<li><a class="' . (($selectedKey == ('account/trophies')) ? ('secondaryContent') : ('primaryContent')) . '"
	href="' . XenForo_Template_Helper_Core::link('account/trophies', false, array()) . '">' . 'Trophies' . '</a></li>';
...
$__compilerVar4 .= '
					...
					<li><a
						class="' . (($selectedKey == ('account/two-step')) ? ('secondaryContent') : ('primaryContent')) . '"
						href="' . XenForo_Template_Helper_Core::link('account/two-step', false, array()) . '">' . 'Two-Step Verification' . '</a></li>
...
$__compilerVar6 .= '
	<li>
		<a
			class="' . (($selectedKey == ('account/keyword-alert')) ? ('secondaryContent') : ('primaryContent')) . '"
			href="' . XenForo_Template_Helper_Core::link('account/keyword-alert', false, array()) . '">
			' . 'Keyword Alert' . '
		</a>
	</li>
';
...
$__output .= '
	...
	<div class="mainContentBlock section sectionMain insideSidebar">
		';
$__compilerVar7 = '';
$__compilerVar7 .= $_subView;
$__output .= $this->callTemplateHook('account_wrapper_content', $__compilerVar7, array());
