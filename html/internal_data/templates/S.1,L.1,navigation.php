...
{
$__compilerVar2 .= '<li><a href="' . XenForo_Template_Helper_Core::link('find-new/profile-posts', false, array()) . '">' . 'New Profile Posts' . '</a></li>';
}
$__compilerVar2 .= '
					';
...
<ul class="visitorTabs">
	...
	';
$__compilerVar4 = '';
$__compilerVar3 .= $this->callTemplateHook('navigation_visitor_tabs_start', $__compilerVar4, array());
...
'title' => 'View your profile'
				...
				';
$__compilerVar5 = '';
$__compilerVar5 .= XenForo_Template_Helper_Core::callHelper('plainusertitle', array(
'0' => $visitor
));
if (trim($__compilerVar5) !== '')
{
$__compilerVar3 .= '<div class="muted">' . $__compilerVar5 . '</div>';
}
...
if ($canEditProfile)
{
$__compilerVar6 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/personal-details', false, array()) . '">' . 'Personal Details' . '</a></li>';
}
$__compilerVar6 .= '
					';
if ($canEditSignature)
{
$__compilerVar6 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/signature', false, array()) . '">' . 'Signature' . '</a></li>';
}
$__compilerVar6 .= '
...
if ($canUploadAvatar)
{
$__compilerVar6 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/avatar', false, array()) . '" class="OverlayTrigger" data-cacheOverlay="true">' . 'Avatar' . '</a></li>';
}
$__compilerVar6 .= '
					';
if ($xenOptions['facebookAppId'] OR $xenOptions['twitterAppKey'] OR $xenOptions['googleClientId'])
{
$__compilerVar6 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/external-accounts', false, array()) . '">' . 'External Accounts' . '</a></li>';
}
$__compilerVar6 .= '
...
{
$__compilerVar7 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/keyword-alert', false, array()) . '">' . 'Keyword Alert' . '</a></li>';
}
$__compilerVar6 .= $__compilerVar7;
unset($__compilerVar7);
$__compilerVar6 .= '
';
$__compilerVar3 .= $this->callTemplateHook('navigation_visitor_tab_links1', $__compilerVar6, array());
...
$__compilerVar8 .= '
				...
				';
$__compilerVar3 .= $this->callTemplateHook('navigation_visitor_tab_links2', $__compilerVar8, array());
...
$__compilerVar9 .= '
				<li><a href="' . XenForo_Template_Helper_Core::link('account/likes', false, array()) . '">' . 'Likes You\'ve Received' . '</a></li>
			';
$__compilerVar3 .= $this->callTemplateHook('navigation_tabs_account', $__compilerVar9, array());
...
{
$__compilerVar3 .= '<a href="' . XenForo_Template_Helper_Core::link('conversations/add', false, array()) . '" class="floatLink">' . 'Start a New Conversation' . '</a>';
}
$__compilerVar3 .= '
...
$__compilerVar3 .= '
	...
	';
$__compilerVar10 = '';
$__compilerVar3 .= $this->callTemplateHook('navigation_visitor_tabs_middle', $__compilerVar10, array());
...
$__compilerVar3 .= '
	...
	';
$__compilerVar11 = '';
$__compilerVar3 .= $this->callTemplateHook('navigation_visitor_tabs_end', $__compilerVar11, array());
