...
)), ENT_QUOTES, 'UTF-8', true) . '"') : ('')) . ' data-ac-url="' . XenForo_Template_Helper_Core::link('members/bdtagme-find', false, array()) . '">' . htmlspecialchars($messageHtml, ENT_QUOTES, 'UTF-8') . '</textarea>
