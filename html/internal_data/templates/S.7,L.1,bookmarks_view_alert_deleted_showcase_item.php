...
$__extraData['title'] = '';
$__extraData['title'] .= 'Deleted Showcase Item';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Deleted Showcase Item';
$__output .= '
...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'nflj_showcase_showcase_item' . ':</dt> <dd><span class="ugc">
	';
...
{
$__output .= '
		<a href="' . XenForo_Template_Helper_Core::link('showcase', $item['content'], array()) . '">' . htmlspecialchars($item['content']['title'], ENT_QUOTES, 'UTF-8') . '</a>
	';
}
$__output .= '
	<span></dd></dl>
