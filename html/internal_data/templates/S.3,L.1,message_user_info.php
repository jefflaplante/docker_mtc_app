...
$__compilerVar8 .= '
			...
			';
$__compilerVar6 .= $this->callTemplateHook('message_user_info_extra', $__compilerVar8, array(
'user' => $user,
'isQuickReply' => $isQuickReply
));
...
$__compilerVar9 .= '
			...
			';
$__compilerVar6 .= $this->callTemplateHook('message_user_info_custom_fields', $__compilerVar9, array(
'user' => $user,
'isQuickReply' => $isQuickReply
));
