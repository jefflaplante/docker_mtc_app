...
'img' => 'true'
	...
	<div class="listBlock main">
		<div class="titleText">
			...
			<h3 class="title"><a href="' . XenForo_Template_Helper_Core::link('profile-posts', $profilePost, array()) . '">' . XenForo_Template_Helper_Core::callHelper('snippetext', array(
...
'stripPlainTag' => '1'
		...
		<blockquote class="snippet">
			<a href="' . XenForo_Template_Helper_Core::link('profile-posts', $profilePost, array()) . '">' . XenForo_Template_Helper_Core::callHelper('snippetext', array(
'0' => $profilePost['message'],
'1' => '150',
'2' => array(
'term' => $search['search_query'],
