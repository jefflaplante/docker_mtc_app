						...
						<ul>
							<li><label><input type="checkbox" id="applyPoints" name="points_enable" value="1" class="Disabler" checked="checked" /> ' . 'Apply warning points' . ':</label>
								<ul id="applyPoints_Disabler">
									<li><input type="number" name="points" value="1" class="textCtrl SpinBox number" min="0" step="1" /></li>
								</ul>
							</li>
						</ul>
					</dd>
						...
						<ul>
							<li><label><input type="checkbox" id="expirePoints" name="expiry_enable" value="1" class="Disabler" checked="checked" /> ' . 'Points expire after' . ':</label>
								<ul id="expirePoints_Disabler">
									<li>
										<input type="number" name="expiry_value" value="1" class="textCtrl SpinBox number" min="0" step="1" />
...
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Warn Member' . '" class="button primary" accesskey="s" /></dd>
	</dl>
	...
	<input type="hidden" name="filled_warning_definition_id" value="0" />
