...
{
$__compilerVar5 .= '<span class="xc_icon_before_logo_fa">' . XenForo_Template_Helper_Core::styleProperty('xc_icon_before_logo_fa') . '</span>';
}
$__compilerVar5 .= '
			';
if (XenForo_Template_Helper_Core::styleProperty('xc_enable_text_logo'))
{
$__compilerVar5 .= '<span class="xc_logo_text">' . XenForo_Template_Helper_Core::styleProperty('xc_logo_text') . '</span>
			';
}
else
{
...
{
$__compilerVar5 .= '<span class="xc_logo_secondary_text">' . XenForo_Template_Helper_Core::styleProperty('xc_logo_secondary_text') . '</span>';
}
$__compilerVar5 .= '
...
{
$__compilerVar9 .= '<img src="' . XenForo_Template_Helper_Core::callHelper('avatar', array(
'0' => $visitor,
'1' => 's'
)) . '" class="miniMe" alt="' . htmlspecialchars($visitor_username, ENT_QUOTES, 'UTF-8') . '" />';
}
$__compilerVar9 .= '<strong class="accountUsername">' . htmlspecialchars($visitor['username'], ENT_QUOTES, 'UTF-8') . '</strong>
