...
<form action="' . XenForo_Template_Helper_Core::link('misc/contact', false, array()) . '" method="post" class="xenForm formOverlay AutoValidator" data-redirect="' . (($isOverlay) ? ('no') : ('yes')) . '" data-reset="' . (($isOverlay) ? ('yes') : ('no')) . '">
