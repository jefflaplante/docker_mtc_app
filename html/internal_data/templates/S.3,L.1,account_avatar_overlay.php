...
';
$__compilerVar1 = '';
$__compilerVar1 .= 'account_avatar_overlay';
$__compilerVar2 = '';
$this->addRequiredExternal('js', 'js/Nobita/avatarurl/avatar.js');
$__compilerVar2 .= '

';
if ($__compilerVar1 == ('account_avatar_overlay'))
{
$__compilerVar2 .= '
...
else if ($__compilerVar1 == ('account_avatar'))
{
$__compilerVar2 .= '
	<dl class="ctrlUnit">
...
else if ($__compilerVar1 == ('resource_icon'))
{
$__compilerVar2 .= '
	<li class="iconAction">
		<label for="ctrl_su">' . 'Import a photo from a URL' . ':</label>
