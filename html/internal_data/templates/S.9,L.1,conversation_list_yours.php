...
$__compilerVar2 = '';
$__compilerVar2 .= (($selectedUserId != $visitor['user_id']) ? ('Conversations ' . htmlspecialchars($users[$selectedUserId]['username'], ENT_QUOTES, 'UTF-8') . ' Started') : ('Conversations You Started'));
$__compilerVar3 = '';
if (!$__compilerVar2)
{
$title = '';
...
$__compilerVar3 .= XenForo_Template_Helper_Core::callHelper('pagenavhtml', array('public', htmlspecialchars($conversationsPerPage, ENT_QUOTES, 'UTF-8'), htmlspecialchars($totalConversations, ENT_QUOTES, 'UTF-8'), htmlspecialchars($page, ENT_QUOTES, 'UTF-8'), htmlspecialchars($__compilerVar1, ENT_QUOTES, 'UTF-8'), false, $pageNavParams, false, array())) . '
...
{
$__compilerVar6 .= '<a href="' . XenForo_Template_Helper_Core::link('conversations/starred', false, array()) . '"><span class="starred" title="' . 'Starred' . '">' . 'Starred' . '</span></a>';
}
$__compilerVar6 .= '
				';
...
if ($visitor['user_id'])
{
$__compilerVar5 .= '<a href="' . XenForo_Template_Helper_Core::link('conversations/toggle-read', $conversation, array()) . '" class="ReadToggle"
...
$__compilerVar7 = '';
$__compilerVar8 = '';
$__compilerVar8 .= 'Conversation Management';
$__compilerVar9 = '';
$__compilerVar9 .= '
	...
	';
$__compilerVar10 = '';
$__compilerVar10 .= 'Select / deselect all conversations on this page';
$__compilerVar11 = '';
$__compilerVar11 .= 'Selected Conversations';
$__compilerVar12 = '';
...
$__compilerVar13 = '';
$__compilerVar13 .= '<label title="' . 'Search conversations only' . '"><input type="checkbox" name="type" value="conversation"
	id="search_bar_conversations" checked="checked" /> ' . 'Search conversations only' . '</label>';
$__extraData['searchBar']['conversation'] .= $__compilerVar13;
