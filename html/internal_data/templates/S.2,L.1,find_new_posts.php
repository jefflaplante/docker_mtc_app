...
$__compilerVar8 = '';
$__compilerVar9 = '';
$__compilerVar9 .= 'Thread Moderation';
$__compilerVar10 = '';
$__compilerVar10 .= '
		';
if ($inlineModOptions['delete'])
{
$__compilerVar10 .= '<option value="delete">' . 'Delete Threads' . '...</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['undelete'])
{
$__compilerVar10 .= '<option value="undelete">' . 'Undelete Threads' . '</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['approve'])
{
$__compilerVar10 .= '<option value="approve">' . 'Approve Threads' . '</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['unapprove'])
{
$__compilerVar10 .= '<option value="unapprove">' . 'Unapprove Threads' . '</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['stick'])
{
$__compilerVar10 .= '<option value="stick">' . 'Stick Threads' . '</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['unstick'])
{
$__compilerVar10 .= '<option value="unstick">' . 'Unstick Threads' . '</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['lock'])
{
$__compilerVar10 .= '<option value="lock">' . 'Lock Threads' . '</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['unlock'])
{
$__compilerVar10 .= '<option value="unlock">' . 'Unlock Threads' . '</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['move'])
{
$__compilerVar10 .= '<option value="move">' . 'Move Threads' . '...</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['merge'])
{
$__compilerVar10 .= '<option value="merge">' . 'Merge Threads' . '...</option>';
}
$__compilerVar10 .= '
		';
if ($inlineModOptions['edit'])
{
$__compilerVar10 .= '<option value="prefix">' . 'Apply Thread Prefix' . '...</option>';
}
$__compilerVar10 .= '
		<option value="deselect">' . 'Deselect Threads' . '</option>
	';
$__compilerVar11 = '';
$__compilerVar11 .= 'Select / deselect all threads on this page';
$__compilerVar12 = '';
$__compilerVar12 .= 'Selected Threads';
$__compilerVar13 = '';
...
<span id="InlineModControls">
	<span class="selectionControl secondaryContent">
		<label for="ModerationCheck">
			' . 'Select All' . ' <input type="checkbox" id="ModerationCheck" title="' . htmlspecialchars($__compilerVar11, ENT_QUOTES, 'UTF-8') . '" />
		</label>
		...
		<a class="SelectionCount">' . htmlspecialchars($__compilerVar12, ENT_QUOTES, 'UTF-8') . ': <em class="InlineModCheckedTotal">0</em></a>
	</span>
...
if ($inlineModOptions['delete'])
{
$__compilerVar13 .= '<input type="submit" class="button" value="' . 'Delete' . '..." name="delete" />';
}
$__compilerVar13 .= '
			';
if ($inlineModOptions['approve'])
{
$__compilerVar13 .= '<input type="submit" class="button" value="' . 'Approve' . '" name="approve" />';
}
$__compilerVar13 .= '
		</span>
