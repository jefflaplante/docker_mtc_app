...
<div class="PageNav' . (($maxDigits > 4) ? (' pn' . htmlspecialchars($maxDigits, ENT_QUOTES, 'UTF-8')) : ('')) . '"
	data-bookmarksPage="' . htmlspecialchars($currentPage, ENT_QUOTES, 'UTF-8') . '"
...
'_params' => $linkParams,
'bookmarksPage' => $pageNumberSentinel
)) . '">
...
'_params' => $linkParams,
'bookmarksPage' => (($prevPage > 1) ? ($prevPage) : (''))
)) . '" class="text">&lt; ' . 'Prev' . '</a>
			';
...
{
$__output .= '
			<a class="PageNavPrev ' . (($startPage <= 2) ? ('hidden') : ('')) . '"><b>&larr;</b></a> <span class="scrollable"><span class="items">
		';
}
$__output .= '
