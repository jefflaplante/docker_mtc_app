...
'1' => '0'
		...
		<blockquote class="status baseHtml">' . XenForo_Template_Helper_Core::callHelper('profileBbCode', array(
'0' => 'member_card',
'1' => $user['status']
)) . '</blockquote>
...
$__compilerVar3 .= '
';
if (XenForo_Template_Helper_Core::styleProperty('cbuaCard'))
{
$__compilerVar3 .= '
...
{
$__compilerVar4 .= '
				<dt>' . 'Bookmarks' . ':</dt> <dd><a href="' . XenForo_Template_Helper_Core::link('members', $user, array()) . '#bookmarks" class="concealed">' . XenForo_Template_Helper_Core::numberFormat($user['bookmarks_count'], '0') . '</a></dd>
			';
}
$__compilerVar4 .= '
		';
...
$__output .= '
';
$this->addRequiredExternal('css', 'conversationbutton_card');
$__output .= '
';
if (XenForo_Template_Helper_Core::styleProperty('cbuaCard'))
{
...
{
$__output .= '
    <dl class="convButtonCard convButtonCardM"><a href="' . XenForo_Template_Helper_Core::link('conversations/add', '', array(
'to' => $user['username']
)) . '" ';
...
';
if (XenForo_Template_Helper_Core::styleProperty('cbuaMobileCard'))
{
$__output .= '
<style type="text/css">
';
