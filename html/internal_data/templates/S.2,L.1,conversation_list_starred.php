...
$__compilerVar2 = '';
$__compilerVar2 .= (($selectedUserId != $visitor['user_id']) ? ('' . htmlspecialchars($users[$selectedUserId]['username'], ENT_QUOTES, 'UTF-8') . '\'s Starred Conversations') : ('Starred Conversations'));
$__compilerVar3 = '';
if (!$__compilerVar2)
{
$title = '';
