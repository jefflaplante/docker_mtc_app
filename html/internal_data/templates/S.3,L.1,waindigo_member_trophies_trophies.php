...
$__output .= '
						';
if (XenForo_Template_Helper_Core::numberFormat(count($parentTrophyCategories), '0') > 1 || $trophyCategoryId)
{
$__output .= '
							<h3 class="subHeading">
								';
if ($trophyCategoryId)
{
$__output .= htmlspecialchars($parentTrophyCategory['title'], ENT_QUOTES, 'UTF-8') . ' &gt; ' . htmlspecialchars($trophyCategory['title'], ENT_QUOTES, 'UTF-8');
}
else
{
