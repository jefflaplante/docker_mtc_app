...
.xenForm .ctrlUnit > dd .textCtrl
{
	...
	{
		width: calc(100% - ' . XenForo_Template_Helper_Core::styleProperty('formCtrlIndent') . ');
	}
...
{
	padding-top: ' . (max(0, XenForo_Template_Helper_Core::styleProperty('textCtrl.padding-top') - 2)) . 'px;
	min-height: 25px;
}
...
@media (max-width:' . XenForo_Template_Helper_Core::styleProperty('maxResponsiveMediumWidth') . ')
{
	...
	.Responsive .xenForm .ctrlUnit {padding: 0 ' . XenForo_Template_Helper_Core::styleProperty('uix_gutterWidth') . ';}
