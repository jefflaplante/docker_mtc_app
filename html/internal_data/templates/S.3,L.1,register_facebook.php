...
$__output .= '
			';
if ($existingUser AND $emailMatch)
{
$__output .= '
				<dl class="ctrlUnit">
					<dt>' . 'Associate with' . ':</dt>
...
$__output .= '
			...
			<dl class="ctrlUnit fullWidth">
				<dt></dt>
				<dd>
					' . 'To associate with an existing account, you must first log into that account and then start the association via the <a href="' . XenForo_Template_Helper_Core::link('account/external-accounts', false, array()) . '">external accounts area</a>.' . '
				</dd>
			</dl>
		';
}
