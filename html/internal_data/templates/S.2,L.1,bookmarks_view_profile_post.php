...
$__extraData['navigation'][] = array('href' => XenForo_Template_Helper_Core::link('full:members', '', array(
'user_id' => $item['content']['profile_user_id']
)), 'value' => htmlspecialchars($item['content']['profile_username'], ENT_QUOTES, 'UTF-8'));
$__output .= '
...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'Profile Post' . ':</dt> <dd><span class="ugc"><a href="' . XenForo_Template_Helper_Core::link('profile-posts', '', array(
'profile_post_id' => $item['content_id']
)) . '">' . htmlspecialchars($item['content']['profile_username'], ENT_QUOTES, 'UTF-8') . '</a><span></dd></dl>
