...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'xengallery_media' . ':</dt> <dd><span class="ugc"><a href="' . XenForo_Template_Helper_Core::link('media', $item['content'], array()) . '">
	' . htmlspecialchars($item['content']['media_title'], ENT_QUOTES, 'UTF-8') . '</a><span></dd></dl>
