...
$__compilerVar1 .= '
			';
$__compilerVar2 = '';
$__compilerVar2 .= '<div class=\'skin_branding\'><span><a href="http://www.xenfocus.com">Xenforo skin</a> by </span><a href="http://www.xenfocus.com">Xenfocus</a></div>';
...
if ($homeLink)
{
$__compilerVar3 .= '<li><a href="' . htmlspecialchars($homeLink, ENT_QUOTES, 'UTF-8') . '" class="homeLink">' . 'Home' . '</a></li>';
}
$__compilerVar3 .= '
			...
			';
$__compilerVar1 .= $this->callTemplateHook('footer_links', $__compilerVar3, array());
...
if ($tosUrl)
{
$__compilerVar4 .= '<li><a href="' . htmlspecialchars($tosUrl, ENT_QUOTES, 'UTF-8') . '">' . 'Terms and Rules' . '</a></li>';
}
$__compilerVar4 .= '
				';
if ($xenOptions['privacyPolicyUrl'])
{
$__compilerVar4 .= '<li><a href="' . htmlspecialchars($xenOptions['privacyPolicyUrl'], ENT_QUOTES, 'UTF-8') . '">' . 'Privacy Policy' . '</a></li>';
}
$__compilerVar4 .= '
			';
$__compilerVar1 .= $this->callTemplateHook('footer_links_legal', $__compilerVar4, array());
...
$thCopyrightShown = '';
$thCopyrightShown .= '1';
$__compilerVar1 .= '<div id="thCopyrightNotice">Some XenForo functionality crafted by <a href="http://xf.themehouse.io/" title="Premium XenForo Add-ons" target="_blank">ThemeHouse</a>.</div>';
}
$__compilerVar1 .= '
            ';
...
$__compilerVar1 .= '</div>
			';
$__compilerVar5 = '';
$__compilerVar1 .= $this->callTemplateHook('footer_after_copyright', $__compilerVar5, array());
...
if ($page_time)
{
$__compilerVar6 .= '<dt>' . 'Timing' . ':</dt> <dd><a href="' . htmlspecialchars($debug_url, ENT_QUOTES, 'UTF-8') . '" rel="nofollow">' . '' . XenForo_Template_Helper_Core::numberFormat($page_time, '4') . ' seconds' . '</a></dd>';
}
$__compilerVar6 .= '
						';
if ($memory_usage)
{
$__compilerVar6 .= '<dt>' . 'Memory' . ':</dt> <dd>' . '' . XenForo_Template_Helper_Core::numberFormat(($memory_usage / 1024 / 1024), '3') . ' MB' . '</dd>';
}
$__compilerVar6 .= '
						';
if ($db_queries)
{
$__compilerVar6 .= '<dt>' . 'DB Queries' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($db_queries, '0') . '</dd>';
}
$__compilerVar6 .= '
					';
