...
{
$__output .= '<img src="' . XenForo_Template_Helper_Core::callHelper('avatar', array(
'0' => $visitor,
'1' => 's'
)) . '" class="miniMe" alt="' . htmlspecialchars($visitor_username, ENT_QUOTES, 'UTF-8') . '" />';
}
$__output .= '<strong class="accountUsername">' . htmlspecialchars($visitor['username'], ENT_QUOTES, 'UTF-8') . '</strong>
...
'title' => 'View your profile'
				...
				';
$__compilerVar2 = '';
$__compilerVar2 .= XenForo_Template_Helper_Core::callHelper('plainusertitle', array(
'0' => $visitor
));
...
{
$__compilerVar4 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/keyword-alert', false, array()) . '">' . 'Keyword Alert' . '</a></li>';
}
...
{
$__compilerVar5 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/upgrades', false, array()) . '">' . 'Account Upgrades' . '</a></li>';
}
$__compilerVar5 .= '
					<li><a href="' . XenForo_Template_Helper_Core::link('account/two-step', false, array()) . '">' . 'Two-Step Verification' . '</a></li>
				';
$__output .= $this->callTemplateHook('navigation_visitor_tab_links2', $__compilerVar5, array());
...
$__compilerVar6 .= '
				<li><a href="' . XenForo_Template_Helper_Core::link('account/likes', false, array()) . '">' . 'Likes You\'ve Received' . '</a></li>
			';
$__output .= $this->callTemplateHook('navigation_tabs_account', $__compilerVar6, array());
...
$__output .= '
	...
	';
$__compilerVar7 = '';
$__output .= $this->callTemplateHook('navigation_visitor_tabs_middle', $__compilerVar7, array());
...
$__output .= '
	...
	';
$__compilerVar8 = '';
$__output .= $this->callTemplateHook('navigation_visitor_tabs_end', $__compilerVar8, array());
