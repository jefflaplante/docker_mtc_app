...
$__compilerVar5 .= '
						...
						<ul id="ctrl_edit_post_date_Disabler">
							<li>';
$__compilerVar6 = '';
$__compilerVar6 .= '<select name="month" class="textCtrl autoSize">
...
<li id="' . (($__compilerVar10) ? ('AttachedFileTemplate') : ('attachment' . htmlspecialchars($__compilerVar11['attachment_id'], ENT_QUOTES, 'UTF-8'))) . '"
	class="AttachedFile ' . (($__compilerVar11 and $__compilerVar11['thumbnailUrl']) ? ('AttachedImage') : ('')) . ' secondaryContent">

	<div class="Thumbnail">
		';
if ($__compilerVar11 and $__compilerVar11['thumbnailUrl'])
{
$__compilerVar12 .= '
			<a href="' . XenForo_Template_Helper_Core::link('attachments', $__compilerVar11, array()) . '" target="_blank"
				data-attachmentId="' . htmlspecialchars($__compilerVar11['attachment_id'], ENT_QUOTES, 'UTF-8') . '"
				class="_not_LbTrigger" data-href="' . XenForo_Template_Helper_Core::link('misc/lightbox', false, array()) . '"><img
				src="' . htmlspecialchars($__compilerVar11['thumbnailUrl'], ENT_QUOTES, 'UTF-8') . '" alt="' . htmlspecialchars($__compilerVar11['filename'], ENT_QUOTES, 'UTF-8') . '"
				class="_not_LbImage" data-src="' . XenForo_Template_Helper_Core::link('attachments', $__compilerVar11, array(
'embedded' => '1'
)) . '" /></a>
		';
}
...
$__compilerVar12 .= '
	...
	<div class="AttachmentText">
		<div class="Filename"><a href="' . XenForo_Template_Helper_Core::link('attachments', $__compilerVar11, array()) . '" target="_blank">' . (($__compilerVar11) ? (htmlspecialchars($__compilerVar11['filename'], ENT_QUOTES, 'UTF-8')) : ('')) . '</a></div>
...
'attachments' => ''
			...
			';
if ($__compilerVar11['thumbnailUrl'])
{
$__compilerVar12 .= '
...
$__compilerVar12 .= '
			...
			<div class="controls JsOnly">				
				<input type="button" value="' . 'Delete' . '" class="button smallButton AttachmentDeleter" data-href="' . XenForo_Template_Helper_Core::link('attachments/delete', $__compilerVar11, array()) . '" />
...
$__compilerVar16 .= $__compilerVar18;
