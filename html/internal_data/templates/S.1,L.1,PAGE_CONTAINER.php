...
if ($homeLink)
{
$__compilerVar66 .= '<li><a href="' . htmlspecialchars($homeLink, ENT_QUOTES, 'UTF-8') . '" class="homeLink">' . 'Home' . '</a></li>';
}
$__compilerVar66 .= '
			...
			';
$__compilerVar65 .= $this->callTemplateHook('footer_links', $__compilerVar66, array());
...
if ($tosUrl)
{
$__compilerVar67 .= '<li><a href="' . htmlspecialchars($tosUrl, ENT_QUOTES, 'UTF-8') . '">' . 'Terms and Rules' . '</a></li>';
}
$__compilerVar67 .= '
				';
if ($xenOptions['privacyPolicyUrl'])
{
$__compilerVar67 .= '<li><a href="' . htmlspecialchars($xenOptions['privacyPolicyUrl'], ENT_QUOTES, 'UTF-8') . '">' . 'Privacy Policy' . '</a></li>';
}
$__compilerVar67 .= '
			';
$__compilerVar65 .= $this->callTemplateHook('footer_links_legal', $__compilerVar67, array());
...
$__compilerVar65 .= '</div>
			';
$__compilerVar68 = '';
$__compilerVar65 .= $this->callTemplateHook('footer_after_copyright', $__compilerVar68, array());
...
if ($page_time)
{
$__compilerVar69 .= '<dt>' . 'Timing' . ':</dt> <dd><a href="' . htmlspecialchars($debug_url, ENT_QUOTES, 'UTF-8') . '" rel="nofollow">' . '' . XenForo_Template_Helper_Core::numberFormat($page_time, '4') . ' seconds' . '</a></dd>';
}
$__compilerVar69 .= '
						';
if ($memory_usage)
{
$__compilerVar69 .= '<dt>' . 'Memory' . ':</dt> <dd>' . '' . XenForo_Template_Helper_Core::numberFormat(($memory_usage / 1024 / 1024), '3') . ' MB' . '</dd>';
}
$__compilerVar69 .= '
						';
if ($db_queries)
{
$__compilerVar69 .= '<dt>' . 'DB Queries' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($db_queries, '0') . '</dd>';
}
$__compilerVar69 .= '
					';
if (trim($__compilerVar69) !== '')
{
$__compilerVar65 .= '
...
';
$__compilerVar70 .= $this->callTemplateHook('page_container_js_body', $__compilerVar71, array());
unset($__compilerVar71);
$__compilerVar70 .= '

</script>';
$__compilerVar5 .= $__compilerVar70;
