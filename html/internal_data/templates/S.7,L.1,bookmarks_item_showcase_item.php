...
{
$__output .= '
	' . '' . htmlspecialchars($content['username'], ENT_QUOTES, 'UTF-8') . '\'s showcase' . ':
';
}
$__output .= '
...
{
$__output .= '
	<a href="' . XenForo_Template_Helper_Core::link('showcase', $content, array()) . '" class="PreviewTooltip" data-previewUrl="' . htmlspecialchars($content['preview_url'], ENT_QUOTES, 'UTF-8') . '">
...
<a href="' . XenForo_Template_Helper_Core::link('bookmarks/view-item', $item, array()) . '" class="OverlayTrigger">' . htmlspecialchars($content['message'], ENT_QUOTES, 'UTF-8') . '</a>
</p>
...
{
$__output .= '
	<a href="' . XenForo_Template_Helper_Core::link('showcase/category', $content, array()) . '">' . htmlspecialchars($content['category_title'], ENT_QUOTES, 'UTF-8') . '</a> :' . 'category' . '</h4>
';
}
else
{
$__output .= '
	' . 'category' . ': <a href="' . XenForo_Template_Helper_Core::link('showcase/category', $content, array()) . '">' . htmlspecialchars($content['category_title'], ENT_QUOTES, 'UTF-8') . '</a></h4>
';
}
$__output .= '
